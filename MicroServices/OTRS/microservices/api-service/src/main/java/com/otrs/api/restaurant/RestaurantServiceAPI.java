package com.otrs.api.restaurant;
...
public class RestaurantServiceAPI {
	...
	public ResponseEntity<Restaurant> getRestaurant(@PathVariable("restaurant-id") int restaurantId) {
	...
	/**
	 * Fetch restaurants with the specified name. A partial case-insensitive match
	 * is supported. So <code>http://.../restaurants/rest</code> will find any
	 * restaurants with upper or lower case 'rest' in their name.
	 *
	 * @param name
	 ...
	 * @param restaurantId
	 */
	public ResponseEntity<Restaurant> defaultRestaurant(@PathVariable int restaurantId) {
